document.addEventListener('DOMContentLoaded', function () {
  ...
  function initScrollAnimations() {
    const selector = ANIMATION_SELECTORS.join(', ');
  ...
  if ('IntersectionObserver' in window) {
    ...
    const animatedElements = initScrollAnimations();
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "תענוגות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cfd81716-aa00-48d1-b73d-90ffbe50d329',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cfd81716-aa00-48d1-b73d-90ffbe50d329';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cfd81716-aa00-48d1-b73d-90ffbe50d329';
